...
/**
 * <code>BEJalaliCalendar</code> is a concrete subclass of
 * {@link BECalendar}
 * and provides the standard calendar used in Iran.
 * <p/>
 * <p/>
 * The Jalali calendar has 2 eras, BH (Before Hegira) and AH (After Hegira).
 * <p/>
 * <p/>
 * <code>BEJalaliCalendar</code> implements <em>proleptic</em> Jalali
 * calendar. That is, dates are computed by extrapolating the current
 * rules indefinitely far backward and forward in time. As a result,
 * <code>BEJalaliCalendar</code> may be used for all years to generate
 ...
 * pdt.setStartRule(BEJalaliCalendar.FARVARDIN, 2, 0);
 * pdt.setEndRule(BEJalaliCalendar.SHAHRIVAR, 31, 0);
 * <p/>
 * // create a BEJalaliCalendar with the Tehran Daylight time zone
 * // and the current date and time
 * BECalendar calendar = new BEJalaliCalendar(pdt);
 * Date trialTime = new Date();
 * calendar.setTime(trialTime);
 * <p/>
 * // print out a bunch of interesting things
 * System.out.println("ERA: " + calendar.get(BECalendar.ERA));
 * System.out.println("YEAR: " + calendar.get(BECalendar.YEAR));
 * System.out.println("MONTH: " + calendar.get(BECalendar.MONTH));
 * System.out.println("WEEK_OF_YEAR: " + calendar.get(BECalendar.WEEK_OF_YEAR));
 * System.out.println("WEEK_OF_MONTH: " + calendar.get(BECalendar.WEEK_OF_MONTH));
 * System.out.println("DATE: " + calendar.get(BECalendar.DATE));
 * System.out.println("DAY_OF_MONTH: " + calendar.get(BECalendar.DAY_OF_MONTH));
 * System.out.println("DAY_OF_YEAR: " + calendar.get(BECalendar.DAY_OF_YEAR));
 * System.out.println("DAY_OF_WEEK: " + calendar.get(BECalendar.DAY_OF_WEEK));
 * System.out.println("DAY_OF_WEEK_IN_MONTH: "
 *                    + calendar.get(BECalendar.DAY_OF_WEEK_IN_MONTH));
 * System.out.println("AM_PM: " + calendar.get(BECalendar.AM_PM));
 * System.out.println("HOUR: " + calendar.get(BECalendar.HOUR));
 * System.out.println("HOUR_OF_DAY: " + calendar.get(BECalendar.HOUR_OF_DAY));
 * System.out.println("MINUTE: " + calendar.get(BECalendar.MINUTE));
 * System.out.println("SECOND: " + calendar.get(BECalendar.SECOND));
 * System.out.println("MILLISECOND: " + calendar.get(BECalendar.MILLISECOND));
 * System.out.println("ZONE_OFFSET: "
 *                    + (calendar.get(BECalendar.ZONE_OFFSET)/(60*60*1000)));
 * System.out.println("DST_OFFSET: "
 *                    + (calendar.get(BECalendar.DST_OFFSET)/(60*60*1000)));
 * <p/>
 * System.out.println("Current Time, with hour reset to 3");
 * calendar.clear(BECalendar.HOUR_OF_DAY); // so doesn't override
 * calendar.set(BECalendar.HOUR, 3);
 * System.out.println("ERA: " + calendar.get(BECalendar.ERA));
 * System.out.println("YEAR: " + calendar.get(BECalendar.YEAR));
 * System.out.println("MONTH: " + calendar.get(BECalendar.MONTH));
 * System.out.println("WEEK_OF_YEAR: " + calendar.get(BECalendar.WEEK_OF_YEAR));
 ...
 * System.out.println("MILLISECOND: " + calendar.get(BECalendar.MILLISECOND));
 * System.out.println("ZONE_OFFSET: "
 *        + (calendar.get(BECalendar.ZONE_OFFSET)/(60*60*1000))); // in hours
 * System.out.println("DST_OFFSET: "
 *        + (calendar.get(BECalendar.DST_OFFSET)/(60*60*1000))); // in hours
 * </pre>
 * </blockquote>
 *
 ...
 * @since JDK1.1
 */
class BEJalaliCalendar extends BECalendar {
    /*
     ...
     *
     * With the Jalali calendar, the leap years have a period of 33 years,
     ...
     * numbers, Jalali calendar days, or epoch days, are also longs. Years
     * can fit into an int.
     */
...
//////////////////
    ...
    private static final int LEAST_MAX_VALUES[] = {
        1, 292269054, 11, 52, 5, 29, 365, 7, 4, 1, 11, 23, 59, 59, 999, 12 * ONE_HOUR, 1 * ONE_HOUR
    };
...
///////////////
    ...
    /**
     * Constructs a default BEJalaliCalendar using the current time
     * in the default time zone with the default locale.
     */
    public BEJalaliCalendar() {
        this(TimeZone.getDefault(), Locale.getDefault());
    }

    /**
     * Constructs a BEJalaliCalendar based on the current time
     * in the given time zone with the default locale.
     *
     * @param zone the given time zone.
     */
    public BEJalaliCalendar(TimeZone zone) {
     ...
     */
    public BEJalaliCalendar(Locale aLocale) {
     ...
     * @param aLocale the given locale.
     */
    public BEJalaliCalendar(TimeZone zone, Locale aLocale) {
        super(zone, aLocale);
        setTimeInMillis(System.currentTimeMillis());
    }

    /**
     * Constructs a BEJalaliCalendar with the given date set
     * in the default time zone with the default locale.
     *
     ...
     */
    public BEJalaliCalendar(int year, int month, int date) {
    ...
    /**
     * Constructs a BEJalaliCalendar with the given date
     ...
     *               in the calendar.
     */
    public BEJalaliCalendar(int year, int month, int date, int hour,
                            int minute) {
        super(TimeZone.getDefault(), Locale.getDefault());
        this.set(ERA, AH);
        this.set(YEAR, year);
...
/////////////////
    ...
    /**
     * Compares this BEJalaliCalendar to an object reference.
     *
    ...
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof BEJalaliCalendar;
    }

    /**
     * Overrides BECalendar
     ...
     * Please see BECalendar.getMinimum for descriptions on parameters and
     * the return value.
     */
     ...
     * Please see BECalendar.getMaximum for descriptions on parameters and
     * the return value.
     */
     ...
     * Please see BECalendar.getGreatestMinimum for descriptions on parameters
     ...
     * Please see BECalendar.getLeastMaximum for descriptions on parameters and
     * the return value.
     */
     ...
     * maximum would be 30; for "Esf 3, 1380" it s 29.  Similarly for a Hebrew calendar,
    ...
    public int getActualMaximum(int field) {
        switch (field) {
            ...
            case DAY_OF_YEAR:
                ...
                // just fall back on the default implementation in BECalendar (I'm not sure
            ...
            case YEAR:
                 ...
                 */
                {
                    BECalendar cal = (BECalendar) this.clone();
                    cal.setLenient(true);
                ...
                // BEJalaliCalendar, so we can just return the fixed maximum
            default:
...
//////////////////////
    ...
    /**
     * Return true if the current time for this BECalendar is in Daylignt
     * Savings Time.
     * <p/>
...
//        int dayOfWeek = internalGet(DAY_OF_WEEK);
        ...
        // TBD: getOffset assumes a BEGregorianCalendar
...
//        boolean isLeap;
        ...
        // The Jalali base day we use is zero for Friday Farvardin 1, 1376.
...
/////////////////////////////
    ...
    protected void computeTime() {
        ...
        int year = (stamp[YEAR] != UNSET) ? internalGet(YEAR) : BASE_YEAR;
...
//                dow = jalaliDayToDayOfWeek(jalaliDay);
     ...
     */
    private final long computeJalaliDay(int year) {
        int month = 0, date, y;
...
/////////////////
     ...
     * @return the Jalali day number.
     */
    private static final long millisToJalaliDay(long millis) {
     ...
     */
    private static final long jalaliDayToMillis(long jalali) {
        return (jalali - EPOCH_JALALI_DAY) * ONE_DAY;
    }

    private static final int jalaliDayToDayOfWeek(long jalali) {
