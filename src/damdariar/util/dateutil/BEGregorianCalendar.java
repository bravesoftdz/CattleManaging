...
/**
 * This is a copy of <code>java.util.GregorianCalendar</code> allowing package level access to its members.
 *
 ...
 * @since JDK1.1
 */
class BEGregorianCalendar extends BECalendar {
    /*
...
/////////////////////
    ...
    /**
     * Midnight, local time (using this BECalendar's TimeZone) at or before the
...
///////////////
    ...
    /**
     * Constructs a default BEGregorianCalendar using the current time
     * in the default time zone with the default locale.
     */
    public BEGregorianCalendar() {
        this(TimeZone.getDefault(), Locale.getDefault());
    }

    /**
     * Constructs a BEGregorianCalendar based on the current time
     * in the given time zone with the default locale.
     *
     * @param zone the given time zone.
     */
    public BEGregorianCalendar(TimeZone zone) {
     ...
     */
    public BEGregorianCalendar(Locale aLocale) {
     ...
     * @param aLocale the given locale.
     */
    public BEGregorianCalendar(TimeZone zone, Locale aLocale) {
        super(zone, aLocale);
        setTimeInMillis(System.currentTimeMillis());
    }

    /**
     * Constructs a BEGregorianCalendar with the given date set
     * in the default time zone with the default locale.
     *
     ...
     */
    public BEGregorianCalendar(int year, int month, int date) {
    ...
    /**
     * Constructs a BEGregorianCalendar with the given date
     ...
     *               in the calendar.
     */
    public BEGregorianCalendar(int year, int month, int date, int hour,
                               int minute) {
        super(TimeZone.getDefault(), Locale.getDefault());
        this.set(ERA, AD);
        this.set(YEAR, year);
...
/////////////////
    ...
    /**
     * Sets the BEGregorianCalendar change date. This is the point when the switch
    ...
    public void setGregorianChange(Date date) {
        ...
        // values.
        BEGregorianCalendar cal = new BEGregorianCalendar(getTimeZone());
        cal.setTime(date);
    ...
    /**
     * Gets the Gregorian BECalendar change date.  This is the point when the
    ...
    /**
     * Compares this BEGregorianCalendar to an object reference.
     *
    ...
    public boolean equals(Object obj) {
        return super.equals(obj) &&
                obj instanceof BEGregorianCalendar &&
                gregorianCutover == ((BEGregorianCalendar) obj).gregorianCutover;
    }

    /**
     * Override hashCode.
     * Generates the hash code for the BEGregorianCalendar object
     */
    public int hashCode() {
            ...
            case WEEK_OF_YEAR:
                {
                    ...
                    if (internalGet(MONTH) == BECalendar.JANUARY) {
                        if (woy >= 52) {
                            --isoYear;
    ...
    public int getActualMaximum(int field) {
         ...
         * won't behave properly at the extreme limits of BEGregorianCalendar's
        ...
        switch (field) {
            ...
            case YEAR:
                ...
                // BEGregorianCalendar, so we can just return the fixed maximum
            default:
...
//////////////////////
    ...
    int getISOYear() {
        ...
        if (internalGet(MONTH) == BECalendar.JANUARY) {
            ...
            /* BUG: the following line adde by --BE */
            if (internalGet(MONTH) == BECalendar.DECEMBER) {
                if (woy == 1) {
                    ++isoYear;
                }
            }
