...
public class ViewSelectSineDaroForm extends AbstractForm{
     static int i= 1;
	ViewSelectSineDaroForm() {
		super(ViewSelectSineDaro.class);
	}
	...
	protected boolean beforeSave() {
		if(((ViewSelectSineDaro)($Form_Bean)).getCDaroTajvizId() == null){
		...
		if(list != null && list.size() > 0){
			...
			((ViewSelectSineDaro)($Form_Bean)).setCDaroTajvizId((max != null ? max : 0) + i);
			i++;
		}
		}
		return true;
