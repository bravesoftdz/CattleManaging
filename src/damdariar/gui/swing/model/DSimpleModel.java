...
public class DSimpleModel extends DTableModel{
	...
	public DSimpleModel(Class<?> cls){
		init(cls,null,null,null);
	
	}
	
	public DSimpleModel(Class<?> cls,List<DataModelStatusListener> dataModelStatusListeners){
		init(cls,dataModelStatusListeners,null,null);
	
	}
	
	public DSimpleModel(Class<?> cls,List<DataModelStatusListener> dataModelStatusListeners,String criteria){
		this(cls,dataModelStatusListeners,criteria,"");
	
	
	}
	
	public DSimpleModel(Class<?> cls,List<DataModelStatusListener> dataModelStatusListeners,String criteria,String linkedProperty){
